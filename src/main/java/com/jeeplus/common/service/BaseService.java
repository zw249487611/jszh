...
public abstract class BaseService {
	 ...
	 * @return 标准连接条件对象
	 */
	public static String dataScopeFilter(User user, String officeAlias, String userAlias,String areaAlias) {
...
//							}
						...
						if(StringUtils.isNotBlank(areaAlias)){
							if (Role.DATA_SCOPE_AREA_AND_CHILD.equals(r.getDataScope())){
								sqlString.append(" OR " + areaAlias + ".id = '" + user.getOffice().getArea().getId() + "'");
								sqlString.append(" OR " + areaAlias + ".parent_ids LIKE '" + user.getOffice().getArea().getParentIds() + user.getOffice().getArea().getId() + ",%'");
							}
