package com.jeeplus.modules.app.util;
...
public class EncryptDecryptUtil {
     ...
     * @throws Exception  
     */    
    public EncryptDecryptUtil(String strKey) throws Exception {    
    ...
    /** 字符串默认键值 */    
    private static String strDefaultKey = "renren";    
    /** 加密工具 */    
    ...
    public static void main(String[] args) {    
        try {    
            ...
            EncryptDecryptUtil des1 = new EncryptDecryptUtil();// 使用默认密钥    
            ...
            String test2 = "987654321";    
            EncryptDecryptUtil des2 = new EncryptDecryptUtil("leeme32nz");// 自定义密钥    
