 ...
 * @version 2017-05-09
 */
public class NewJiangsuAb01 extends DataEntity<NewJiangsuAb01> {
	...
	public NewJiangsuAb01() {
		super();
	}

	public NewJiangsuAb01(String id) {
		super(id);
	}
	...
	@ExcelField(title = "分区年度", align = 2, sort = 22)
	...
	@ExcelField(title = "生存状态", align = 2, sort = 16)
	...
	@ExcelField(title = "户主身份证号", align = 2, sort = 23)
