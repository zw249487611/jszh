 ...
 * @version 2017-05-09
 */
public class NewJiangsuAc01E extends DataEntity<NewJiangsuAc01E> {
...
//	private JiangsuAc31 jiangsuAc31; // 贫困户生活条件信息表
	...
	private String pkhsxName;
	private String zcxpkyyName; // 支出性贫困原因
	private String sfzcxpkName; // 是否支出性贫困
	
	
	@ExcelField(title = "是否支出性贫困", align = 2, sort = 13)
	public String getSfzcxpkName() {
		return sfzcxpkName;
	}

	public void setSfzcxpkName(String sfzcxpkName) {
		this.sfzcxpkName = sfzcxpkName;
	}

	@ExcelField(title = "致贫原因", align = 2, sort = 12)
	public String getZcxpkyyName() {
		return zcxpkyyName;
	}

	public void setZcxpkyyName(String zcxpkyyName) {
		this.zcxpkyyName = zcxpkyyName;
	}
	...
	@ExcelField(title = "脱贫标志", align = 2, sort = 11)
	...
	public NewJiangsuAc01E() {
		super();
	}

	public NewJiangsuAc01E(String id) {
		super(id);
	}
...
//	@ExcelField(title = "备注", align = 2, sort = 18)
	...
	@ExcelField(title = "户主姓名", align = 2, sort = 5)
	...
	@ExcelField(title = "户主身份证号", align = 2, sort = 6)
	...
	@ExcelField(title = "家庭人口数", align = 2, sort = 7)
...
//	@ExcelField(title = "户籍编码", align = 2, sort = 4)
	...
	@ExcelField(title = "脱贫年度", align = 2, sort = 14)
