...
function initData2_page3(data) {
	...
	rczf_desc.wzfrs = bfrszfcs.bfrs-bfrszfcs.zfcs;
	// 脱贫分析采集完整率
...
//				value:cjlData
//		}];
//		option_pies[i].series[0].data = pieData;
//		if(cjlData >= 95){
//			option_pies[i].color=['#c1c1c1','#009100'];
//		}else if (cjlData >= 90){
//			option_pies[i].color=['#c1c1c1','#FFD306'];
//		}else{
//			option_pies[i].color=['#c1c1c1','#CE0000'];
//		}
//		option_pies[i].title[0].text = name;
//		option_pies[i].title[1].text = cjl;
//		pies[i].setOption(option_pies[i]);
//	}
...
var option_bar_wzl = {
	...
	xAxis : [ {
		type : 'category',
		data : [ '贫困程度', '脱贫难点', '帮扶措施', '脱贫计划', '脱贫年度', '收入信息', '定位签到', '现场图片' ],
		axisTick : {
			alignWithLabel : true
		}
	} ],
...
//            	var hereColor = ['#0000E3','#2828FF','#4A4AFF','#6A6AFF','#7D7DFF','#9393FF','#AAAAFF','#B9B9FF'];
//                return hereColor[params.dataIndex]
//            }
//        }
//    }
};
