...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="jiangsuAb01" action="${ctx}/bfll/jiangsuAc08/list" method="post" class="form-inline">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			...
			<shiro:hasPermission name="bfll:jiangsuAb01:export">
	       		<table:exportExcel url="${ctx}/bfll/jiangsuAb01/export"></table:exportExcel><!-- 导出按钮 -->
	       	</shiro:hasPermission>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  class="sort-column aac001">帮扶责任人</th>
				<th>操作</th>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="jiangsuAb01">
			<tr>
				<td> <input type="checkbox" id="${jiangsuAb01.id}" class="i-checks"></td>
				<td>
					${jiangsuAb01.aab002}
				</td>
				<td>
				...
				<td>
					...
					<shiro:hasPermission name="bfll:jiangsuAb01:edit">
    					<a href="#" onclick="openDialog('修改贫困人口基本信息', '${ctx}/bfll/jiangsuAb01/form?id=${jiangsuAb01.id}','800px', '500px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 修改</a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="bfll:jiangsuAb01:del">
