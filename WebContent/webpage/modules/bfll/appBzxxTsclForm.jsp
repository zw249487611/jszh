...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="appBzxxTscl" action="${ctx}/bfll/appBzxxTscl/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="xq" htmlEscape="false"    class="form-control "/>
					</td>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="xc" htmlEscape="false"    class="form-control "/>
					</td>
