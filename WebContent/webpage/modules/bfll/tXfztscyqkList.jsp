...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="tXfztscyqk" action="${ctx}/bfll/tXfztscyqk/list1" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable" style="table-layout: fixed;">
		...
		<c:forEach items="${page.list}" var="tXfztscyqk">
			<tr>
				...
				<td>${tXfztscyqk.xz }</td>
				<td>
				<a  href="#" onclick="openDialogView('2018年重点推进项目', '${ctx}/bfll/tXfztscyqk/form?id=${tXfztscyqk.id}','800px', '500px')">
				${tXfztscyqk.cj }
				</a></td>
				<!-- 
				...
				<td>
					<shiro:hasPermission name="bfll:tXfztscyqk:view">
						<a href="#" onclick="openDialogView('2018年重点推进项目', '${ctx}/bfll/tXfztscyqk/form?id=${tXfztscyqk.id}','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</shiro:hasPermission>
					<shiro:hasPermission name="bfll:tXfztscyqk:edit">
