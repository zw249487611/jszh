...
<body class="gray-bg">
	...
	<div class="ibox">
		<h5>帮扶责任人 </h5>
		<form:form id="inputForm" modelAttribute="jiangsuAd01" action="${ctx}/bfll/jiangsuAc08/updatejiedui" method="post" class="form-horizontal">
	...
	<!-- 表格 -->
		<input type="hidden" name="pkhId" value="${pkhId }">
